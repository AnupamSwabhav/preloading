...
type Repository interface {
	...
	DeleteRemaining(uow *UnitOfWork, out interface{}, studID, id uuid.UUID) error
}
...
func (repository *GormRepository) DeleteRemaining(uow *UnitOfWork, entity interface{}, studID, id uuid.UUID) error {
	return uow.DB.Debug().Where("student_id = ? AND id != ?", studID, id).Delete(entity).Error
}
